...
<body style="margin: 50px;">
    ...
    <hr style="size: 50%;"/>
    <a href="01_tampildata.php" ><button type="button" class="btn btn-danger">Tampil</button></a>
    <a href="05_insert.php" ><button type="button" class="btn btn-danger">Tambah</button></a>
    <br>
    <br>
